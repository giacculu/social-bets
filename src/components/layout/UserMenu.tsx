  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 rounded-lg p-2 hover:bg-gray-800 transition-colors"
      >
        {user.image ? (
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full z-50 mt-2 w-56 rounded-xl border border-gray-800 bg-gray-900 p-2 shadow-2xl">
